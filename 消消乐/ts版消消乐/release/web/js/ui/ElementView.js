...
var ElementView = /** @class */ (function (_super) {
    ...
    ElementView.prototype.move = function () {
        Laya.Tween.to(this.thisParent, { x: this.targetX(), y: this.targetY() }, this.speed, Laya.Ease.bounceInOut);
    };
    /*^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
    /*-------------------------------------显示元素，从上方掉落----------------------------------------*/
    /*-------------------------------------掉落后添加到父级别显示列表-----------------------------------*/
    ...
    ElementView.prototype.back = function () {
        Laya.Tween.to(this, { x: this.targetX(), y: this.targetY(), scaleX: 1, scaleY: 1 }, 300, Laya.Ease.cubicOut);
    };
    /*-----------------------------移动元素====消除元素--------------------------------------*/
