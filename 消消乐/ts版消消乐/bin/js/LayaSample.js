...
var GameMain = /** @class */ (function () {
    function GameMain() {
        ...
        var proArray = [{ url: "res/atlas/ui/friend.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/friend.atlas", type: Laya.Loader.ATLAS }];
    ...
    GameMain.prototype.onproloaded = function () {
        var resArray = [];
        resArray.push({ url: "res/atlas/ui/bounced.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/bounced.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/btn.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/btn.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/cloth.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/cloth.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/game.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/game.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/gif.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/gif.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/goldman.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/goldman.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/roulette.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/roulette.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/set.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/set.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/task.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/task.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/tool.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/tool.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/yuehui.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/yuehui.atlas", type: Laya.Loader.ATLAS }, { url: "res/atlas/ui/sigin.png", type: Laya.Loader.IMAGE }, { url: "res/atlas/ui/sigin.atlas", type: Laya.Loader.ATLAS });
    ...
    GameMain.prototype.progress = function (value) {
        if (value >= 1) {
