...
* name;
*/
var spmove = /** @class */ (function () {
    function spmove() {
    }
    spmove.select = function (sprite, img) {
        var _this = this;
        if (gameData.cursp) {
            ...
            if ((dx == 1 && dy == 0) || (dy == 1 && dx == 0)) {
                ...
                Tween.to(gameData.cursp.par, { x: target.x, y: target.y }, 300, Laya.Ease.cubicOut, Laya.Handler.create(this, function () {
                    var t = targetsp;
                    ...
                    if (gamelogic.isHaveThree()) {
                        ...
                        Tween.to(targetsp.par, { x: cur.x, y: cur.y }, 300, Laya.Ease.cubicOut, Laya.Handler.create(_this, function () {
                            var t = targetsp;
                            gameData.sparr[tarindex] = gameData.cursp;
                            targetsp = gameData.cursp;
                            gameData.sparr[gameData.curindex] = t;
        ...
        img.width = 60;
        img.height = 60;
        var length = gameData.sparr.length;
    ...
    spmove.refrsh = function (target1, target2) {
...
//# sourceMappingURL=spmove.js.map